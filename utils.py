...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='Resize2/Resize2/Traint')
    parser.add_argument('--data_path_test', type=str, default='Resize2/Resize2/Test')
    parser.add_argument('--data_name', type=str, default='Realworld', choices=['unified', 'Snow', 'underwater'])
    parser.add_argument('--save_path', type=str, default='result')
    parser.add_argument('--best_path', type=str, default='best psnr folder')
    ...
    parser.add_argument('--channels', nargs='+', type=int, default=[32, 64, 128, 256],
    ...
    parser.add_argument('--patch_size', nargs='+', type=int, default=[128, 128, 128, 128, 128, 128],
